 ...
 */
final class Version20190731154138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom_complet VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contrat ADD vehicule_id INT NOT NULL, ADD reservation_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_603499934A4A3511 ON contrat (vehicule_id)');
        ...
        $this->addSql('ALTER TABLE vehicule ADD categorie_id INT NOT NULL, ADD etat_id INT NOT NULL, ADD modele_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_603499934A4A3511 ON contrat');
        $this->addSql('DROP INDEX UNIQ_60349993B83297E7 ON contrat');
        $this->addSql('ALTER TABLE contrat DROP vehicule_id, DROP reservation_id');
        ...
        $this->addSql('ALTER TABLE vehicule DROP categorie_id, DROP etat_id, DROP modele_id');
    }
}
